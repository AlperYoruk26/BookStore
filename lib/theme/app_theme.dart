...
class AppTheme {
  ...
  static ThemeData lightTheme(Color primaryColor) {
    return ThemeData(
      ...
      navigationBarTheme:
          NavigationBarThemeData(shadowColor: const Color(0xFFD5D5D5)),
  ...
  static ThemeData darkTheme(Color primaryColor) {
    return ThemeData(
      ...
      colorScheme: ColorScheme.light(
        primary: Color(0xFFD45555), // Color(0xFFD45555)
        secondary: Color(0xFF19191B),
      ...
      navigationBarTheme:
          NavigationBarThemeData(shadowColor: const Color(0xFF1F1F2A)),
      cardTheme: CardThemeData(
